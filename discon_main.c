...
int calcOutputController(float rUserVar1, float rUserVar2, float rUserVar3, float rUserVar4, float rUserVar5,float rUserVar6, float rUserVar7, float rUserVar8, float rUserVar9, float rUserVar10,
		...
		float rWaves1,float rWaves2, float rWaves3,
		float rWaves4,float rWaves5, float rWaves6,
	...
	SIG_MODEL(U,Waves_prev_1) = rWaves1;
		SIG_MODEL(U,Waves_prev_2) = rWaves2;
			SIG_MODEL(U,Waves_prev_3) = rWaves3;
				SIG_MODEL(U,Waves_prev_4) = rWaves4;
					SIG_MODEL(U,Waves_prev_5) = rWaves5;
						SIG_MODEL(U,Waves_prev_6) = rWaves6;
...
float* SetParams(float *avrSwap) 
{
	...
	/*if (iStatus == 0) #want to read continues switch this off*/  
	{
		pFile = fopen ("discon_WaveFF.in","r");
...
void __declspec(dllexport) __cdecl DISCON(float *avrSwap, int *aviFail, char *accInfile, char *avcOutname, char *avcMsg) 
{
	...
	float rTime, rSample, rGeneratorSpeed, rRatedSpeed, rBelowRatedPitch, 
			...
			rYawError,rYawBearingRate,rElectricalPower, rWaves1, rWaves2, rWaves3, rWaves4, rWaves5, rWaves6;
	static float rTorqueDemand, rPitchDemand, rBlade1Pitch, rBlade2Pitch, 
			rBlade3Pitch, rYawRate, rLog1,rLog2,rLog3,rLog4,rLog5,rLog6,rLog7,rLog8,rLog9,rLog10;
	...
	iStatus          = NINT(avrSwap[0]);
	rInit			= avrSwap[0];
	rUserVar1		= avrSwap[129];
	rUserVar2		= avrSwap[130];
	rUserVar3		= avrSwap[131];
	rUserVar4		= avrSwap[132];
	rUserVar5		= avrSwap[133];
	rUserVar6		= avrSwap[134];
	rUserVar7		= avrSwap[135];
	rUserVar8		= avrSwap[136];
	rUserVar9		= avrSwap[137];
	rUserVar10		= avrSwap[138];
	rTime            = avrSwap[1];
	rSample          = avrSwap[2];
    ...
    if (iStatus == 0) {
        ...
        aviFail[0] = initiateController(errorMsg);
                ...
                aviFail[0] = calcOutputController(rUserVar1, rUserVar2, rUserVar3, rUserVar4, rUserVar5,rUserVar6, rUserVar7, rUserVar8, rUserVar9, rUserVar10,
						 rInit, rGeneratorSpeed, rRatedSpeed,
						...
						rWaves1, rWaves2, rWaves3, rWaves4, rWaves5, rWaves6,
                        ...
                        &rLog1,&rLog2,&rLog3,&rLog4,&rLog5,&rLog6,&rLog7,&rLog8,&rLog9,&rLog10);
	...
	strcpy(OutName, "Log1:-;Log2:-;Log3:-;Log4:-;Log5:-;Log6:-;Log7:-;Log8:-;Log9:-;Log10:-;"); //Names and units
    avrSwap[145] =rLog1; /*avrSwap[144] = rLog1;*/
	avrSwap[146] =rLog2; /*avrSwap[144] = rLog2;*/
	avrSwap[147] =rLog3; /*avrSwap[144] = rLog3;*/
	avrSwap[148] =rLog4; /*avrSwap[144] = rLog4;*/
	avrSwap[149] =rLog5; /*avrSwap[144] = rLog5;*/
	avrSwap[150] =rLog6; /*avrSwap[144] = rLog6;*/
	avrSwap[151] =rLog7; /*avrSwap[144] = rLog7;*/
	avrSwap[152] =rLog8; /*avrSwap[144] = rLog8;*/
	avrSwap[153] =rLog9; /*avrSwap[144] = rLog9;*/
	avrSwap[154] =rLog10; /*avrSwap[144] = rLog10;*/
    //Return strings
